...
CALL InsertDeleteAccounts('1000000117', 'INSERTSP', 'AV02', '02', 'CO02', 1, now(), 'CO', '');

CALL InsertDeleteAccountsclientes_nuevos('1000000123', 'INSERTSP', 'AV02', '02', 'CO02', 1, now(), 'CO', '1000000117');
